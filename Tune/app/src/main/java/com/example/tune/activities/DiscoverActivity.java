...
public class DiscoverActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txtToolbar.setText("discover");
        setSupportActionBar(toolbar);

        ListView listViewTimeline = findViewById(R.id.discoverListview);
        CustomGenreAdapter adapter = new CustomGenreAdapter(this, Genre.values());
